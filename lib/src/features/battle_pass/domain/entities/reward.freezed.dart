...
mixin _$Reward {
 ...
 String get id; String get title; RewardType get type; int get amount; String get iconAsset; RewardLane get lane;
...
@override
int get hashCode => Object.hash(runtimeType,id,title,type,amount,iconAsset,lane);

@override
String toString() {
  return 'Reward(id: $id, title: $title, type: $type, amount: $amount, iconAsset: $iconAsset, lane: $lane)';
}
...
@useResult
$Res call({
 String id, String title, RewardType type, int amount, String iconAsset, RewardLane lane
});
...
/// Create a copy of Reward
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? type = null,Object? amount = null,Object? iconAsset = null,Object? lane = null,}) {
...
as int,iconAsset: null == iconAsset ? _self.iconAsset : iconAsset // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  RewardType type,  int amount,  String iconAsset,  RewardLane lane)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Reward() when $default != null:
return $default(_that.id,_that.title,_that.type,_that.amount,_that.iconAsset,_that.lane);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  RewardType type,  int amount,  String iconAsset,  RewardLane lane)  $default,) {final _that = this;
switch (_that) {
case _Reward():
return $default(_that.id,_that.title,_that.type,_that.amount,_that.iconAsset,_that.lane);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  RewardType type,  int amount,  String iconAsset,  RewardLane lane)?  $default,) {final _that = this;
switch (_that) {
case _Reward() when $default != null:
return $default(_that.id,_that.title,_that.type,_that.amount,_that.iconAsset,_that.lane);case _:
  return null;
...
class _Reward implements Reward {
  const _Reward({required this.id, required this.title, required this.type, required this.amount, required this.iconAsset, required this.lane});
...
@override final  RewardLane lane;
...
/// Create a copy of Reward
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? type = null,Object? amount = null,Object? iconAsset = null,Object? lane = null,}) {
